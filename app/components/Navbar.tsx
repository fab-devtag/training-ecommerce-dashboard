...
export const Navbar = () => {
  ...
  const { wishCount } = useWishListContext();
  return (
          ...
          <div className="flex items-center space-x-8">
            ...
            <div className="hidden md:flex space-x-4">
              ...
              >
                WishList
                {wishCount > 0 && (
                  <span className="absolute top-2 ml-15 bg-green-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
                    {wishCount}
                  </span>
                )}
              </Link>
